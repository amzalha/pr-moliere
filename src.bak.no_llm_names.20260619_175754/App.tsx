    ...
    <div id="pr-moliere-root" className="min-h-screen bg-[#F8F7F3] text-[#2D2D2D] font-sans flex flex-col antialiased">
            ...
            <div className="flex-1 min-h-[160px] relative">
              {exerciseLoading ? (
                <div className="absolute inset-0 bg-white/95 flex flex-col items-center justify-center z-10 p-6 text-center">
                  ...
                  <p className="text-xs text-[#A39E93] mt-1">Génération en cours avec Gemini...</p>
                </div>
              ) : null}
      ...
      <footer className="bg-white border-t border-[#E5E1D8] py-8 mt-12 text-center text-xs text-[#A39E93] font-medium">
        <div className="max-w-7xl mx-auto px-4 space-y-2">
          ...
          <p>Conforme aux orientations pédagogiques officielles du Ministère de l'Éducation Nationale du Maroc.</p>
